...
export const waMessages: Record<string, string> = {
  ...
  haldi: AVAILABILITY("a haldi ceremony"),
  sangeet: AVAILABILITY("a sangeet night"),
  engagement: AVAILABILITY("an engagement ceremony"),
  newyear: AVAILABILITY("a new year celebration"),
